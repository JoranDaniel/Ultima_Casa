...
<head>
    ...
    <script>
        function showConfirmationPopup() {
            if (confirm("Your information will be shared, do you accept?")) {
                document.getElementById("verkoopForm").submit();
            }
        }
...
<body>
    <div class="container">
        ...
        <form id="verkoopForm" action="verkoopins.php" method="GET" onsubmit="event.preventDefault(); showConfirmationPopup();">
            <div class="row">
...
echo '</div>
            ...
            <div class="row text-center">
                <div class="form-group btop">
                    <button type="submit" class="action-button" id="RID" name="RID" value="' . $relatieid . '" title="Dit huis te koop aanbieden.">Toevoegen</button>
